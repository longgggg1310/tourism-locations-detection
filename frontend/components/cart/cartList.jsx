    ...
    <View>
      ...
      <View style={styles.orderWrapper}>
        ...
        <View style={styles.subs}>
          ...
          <Text style={styles.regularText}>{roundedTotalPrice} km</Text>
        </View>
        <View style={styles.orderRow}>
          <Text style={styles.orderInfo}>Total</Text>
          <Text style={styles.totalTxt}>{roundedTotalPrice} km</Text>
        </View>
      </View>
      ...
      <View style={styles.checkWrapper}>
        <TouchableOpacity onPress={() => {}} style={styles.checkoutBtn}>
          <Text style={styles.checkOutText}>{roundedTotalPrice} km</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
